...
List* CTMUI_NListview<Type>::ChildList() const {
    return (struct List *) Object::mGetAttr(MUIA_Group_ChildList);
}
...
LONG CTMUI_NListview<Type>::horizSpacing() const {
    return (LONG) Object::mGetAttr(MUIA_Group_HorizSpacing);
}

template<typename Type>
Object* CTMUI_NListview<Type>::horizScrollBar() const {
    return (Object *) Object::mGetAttr(MUIA_NListview_Horiz_ScrollBar);
}
...
Object* CTMUI_NListview<Type>::nList() const {
    return (Object *) Object::mGetAttr(MUIA_NListview_NList);
}
...
void CTMUI_NListview<Type>::setColumns(LONG value) {
    Object::Object::setAttr(MUIA_Group_Columns, (IPTR) value);
}

template<typename Type>
void CTMUI_NListview<Type>::setHorizSpacing(LONG value) {
    Object::Object::setAttr(MUIA_Group_HorizSpacing, (IPTR) value);
}

template<typename Type>
void CTMUI_NListview<Type>::setHorizScrollBar(Object *value) {
    Object::setAttr(MUIA_NListview_Horiz_ScrollBar, (IPTR) value);
}
...
void CTMUI_NListview<Type>::setVertScrollBar(Object *value) {
    Object::setAttr(MUIA_NListview_Vert_ScrollBar, (IPTR) value);
}
...
Object* CTMUI_NListview<Type>::vertScrollBar() const {
    return (Object *) Object::mGetAttr(MUIA_NListview_Vert_ScrollBar);
}
