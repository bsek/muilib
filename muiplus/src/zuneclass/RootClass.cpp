...
void Zune::RootClass::addMember(ZuneObject::RootObject *child) {
    addMember(child->getObject());
}

void Zune::RootClass::remMember(ZuneObject::RootObject *child) {
    remMember(child->getObject());
}
